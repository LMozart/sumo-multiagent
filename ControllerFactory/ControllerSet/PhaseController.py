...
class PhaseController(Controller):
    ...
    def __init__(self, traffic_id, net_data, controller_config):
        ...
        # self.input_numb = self.phase_numb + \
        #                   (len(self.net_data['inter'][self.id]['incoming_lanes'])) + \
        #                   (len(self.net_data['inter'][self.id]['inter_phases'])) + 1
        # self.input_numb = self.phase_numb + \
        ...
        # self.input_numb = self.phase_numb + \
        #                   len(self.net_data['inter'][self.id]['incoming_lanes'])
        # self.input_numb = self.phase_numb + 2 + \
        #                   (len(self.net_data['inter'][self.id]['inter_phases'])) + 1
        # self.input_numb = len(self.inter_phases) + 1 + 2 + self.phase_numb
        # self.input_numb = len(self.net_data['inter'][self.id]['incoming_lanes']) * 2
        self.input_numb = len(self.green_phases)
        # self.input_numb = len(self.green_phases) + len(self.net_data['inter'][self.id]['incoming_lanes'])
        # self.input_numb = len(self.green_phases) + (len(self.net_data['inter'][self.id]['inter_phases'])) + self.phase_numb + 1
